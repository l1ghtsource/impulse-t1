...
@router.delete('/sources/{id_source}', tags=['Source'])
...
@router.post('/assistants', tags=['Assistant'])
...
@router.patch('/assistants/{id_assistant}', tags=['Assistant'])
...
@router.delete('/assistants/{id_assistant}', tags=['Assistant'])
...
@router.get('/assistants/{id_assistant}/export', tags=['Assistant'])
...
@router.post("/addServicesAndPrompt", tags=['RAG'])
...
@router.post("/uploadfiles/", tags=['RAG'])
