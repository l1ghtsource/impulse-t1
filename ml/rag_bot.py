...
roles = {
    ...
    "врач": "Ты врач. Твоя задача — предоставить медицинские консультации, основанные на знании человеческого тела и болезней. Быть точным в диагнозах и рекомендациях.",
